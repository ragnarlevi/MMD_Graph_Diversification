...
color_dark = ["#35711b", "#D18700" ,"#8B0000"]
color_light = ["#c3ffa9", "#FFC55C" ,"#FF7276"]
...
def plot_avg_degree(graphs:dict, weight = None, rolling_window = 5, ax = None, graph_index = 'graph_dict', title = None):
    """
...
def plot_G_density(graphs:dict, rolling_window = 5, ax = None, graph_index = 'graph_dict' ):
    """
    graphs assumed to be a dictionary contained in the list generated by Generate_graphs_case_1
    """
